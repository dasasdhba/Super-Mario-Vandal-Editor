    ...
    else
    {
        ...
        if launch_state = 1
        {
            ...
            if launch_count >= launch_time
            {
                ...
                var weapon,wx,xy;
                wx = 14*dir*image_xscale
                wy = -20*image_yscale
                weapon = instance_create(x+wx*cosd(image_angle)+wy*sind(image_angle), y-wx*sind(image_angle)+wy*cosd(image_angle), o_fireball_bros)
